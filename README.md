...
```
2. Запустить утилиту `docker_bench_security` командой:
```sh
...
```
## Отчёт сканирования
Сканирование с помощью утилиты `docker_bench_security`
```log
...
[WARN]      * No SecurityOptions Found: web
...
[WARN]      * MaximumRetryCount is not set to 5: web
...
[WARN]      * Privileges not restricted: web
[WARN]      * Privileges not restricted: db
[WARN] 5.26  - Ensure container health is checked at runtime
[WARN]      * Health check not set: web
...
```
## Запуск исправленного docker-compose
1. Запустить **исправленный** `docker-compose` командой:
```sh
docker-compose -f fix-docker-compose.yml up -d
```
2. Снова запустить проверку утилитой `docker_bench_security`

## Отчёт сканирования
Сканирование с помощью утилиты `docker_bench_security` исправленного `docker-compose`:
```log
[INFO] 5 - Container Runtime
[WARN] 5.1  - Ensure AppArmor Profile is Enabled
[WARN]      * No AppArmorProfile Found: web
